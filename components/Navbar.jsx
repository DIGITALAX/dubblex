  ...
  return (
    <div style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
        <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
            <Link href='/'>
                <h1 style={{ color: `${textColor}`}} className='font-bold text-4xl'>Web3 Maps</h1>
            </Link>

            {/* Tailwind mobile first, everything will be hidden until small breakpoint*/}
            ...
            {/* Mobile Button */}
            {/* Anything above small hidden, otherwise display block */}
